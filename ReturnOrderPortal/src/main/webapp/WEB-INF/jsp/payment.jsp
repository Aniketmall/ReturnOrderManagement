								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="expDate">Expiration</label><span>
											*</span>
										<input type="text" name="exp" class="form-control" placeholder="MM/YY" size="5" id="exp" minlength="5" maxlength="5" pattern="[0-1]{1}[0-9]{1}[/]{1}[2]{1}[1-9]{1}" required="required"/>
									</div><!-- Made Change on 28*06 -->
